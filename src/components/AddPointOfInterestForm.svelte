...
<div class="uk-margin uk-width-2xlarge uk-margin-auto uk-card uk-card-default uk-card-body uk-box-shadow-large">
    <form on:submit|preventDefault={addMonument} class="uk-form-stacked uk-text-left" enctype="multipart/form-data">
        <div class="uk-grid uk-grid-stack">
            <div class="uk-width-1@m">
                <div class="uk-margin">
                    <label class="uk-form-label" for="form-stacked-text">Monument Title</label>
                    <div class="uk-form-controls">
                        <input bind:value={title} class="uk-input" id="form-stacked-text" type="text" name="title"
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls">
                        ...
                        <textarea bind:value={description} class="uk-textarea" id="form-stacked-text" type="text" name="description"
                ...
                <div class="uk-margin">
                    ...
                    <select on:change={populateCountyField} bind:value={province} class="uk-select" name="province" id="provinceSelectField">
                ...
                <div class="uk-margin" uk-grid>
                    ...
                    <div class="uk-width-1-2@m">
                        ...
                        <div class="uk-form-controls">
                            <input bind:value={latitude} class="uk-input" id="form-stacked-text" type="number" step=".0001" name="latitude"
                    ...
                    <div class="uk-width-1-2@m">
                        ...
                        <div class="uk-form-controls">
                            <input bind:value={longitude} class="uk-input" id="form-stacked-text" type="number" step=".0001" name="longitude"
                ...
                <div bind:this={categoryDivContainer} class="uk-margin" id="categoryDivContainer">
                    ...
                    <div class="uk-width-expand@m">
                        <input class="uk-checkbox" name="category" value={individualCategory.title} type="checkbox">
