...
<form on:submit|preventDefault={signUp}>
    <div class="uk-margin">
        <div class="uk-inline uk-width-1-1">
            <span class="uk-form-icon" uk-icon="icon: user"></span> <input bind:value={firstName} class="uk-input uk-form-large" type="text"
                name="firstName">
        </div>
    </div>
    <div class="uk-margin">
        <div class="uk-inline uk-width-1-1">
            <span class="uk-form-icon" uk-icon="icon: user"></span> <input bind:value={lastName} class="uk-input uk-form-large" type="text"
                name="lastName">
        </div>
    </div>
    <div class="uk-margin">
    ...
    <div class="uk-margin">
        <div class="uk-inline uk-width-1-1">
            <select bind:value={userType} class="uk-select uk-form-large" name="userType">
