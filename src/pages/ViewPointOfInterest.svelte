        ...
        <div class="uk-text-center uk-text-small uk-grid uk-margin-top" uk-grid>
          ...
          <div class="uk-width-1-2@m">
            <MonumentCoordinatesComponent
              monumentCoordinates={monument.coordinates}
            />
          </div>
        </div>
            ...
            <div class="uk-card uk-card-default uk-card-body uk-padding-small">
              ...
              <div class="uk-child-width-expand@s uk-text-center" uk-grid>
                ...
                <WeatherOverviewComponent
                  currentWeatherDescription={weatherData.currentWeatherDescription}
                />
              </div>
              <WeatherOverviewTable
                currentWeatherFormattedObject={weatherData.currentWeatherFormattedObject}
              />
            </div>
          </div>
          ...
          <div class="uk-text-center uk-text-small uk-margin uk-width-expand@m">
            <div class="uk-card uk-card-default uk-card-body uk-padding-small">
              ...
              <WeatherForecastTable
                weatherForecastNextWeek={weatherData.weatherForecastNextWeek}
              />
            </div>
          </div>
        {:else}
          <NoWeatherDataComponent {id} />
        {/if}
      </div>
